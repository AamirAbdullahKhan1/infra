...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-[80px] px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center">
          <h1 className="text-3xl font-extrabold text-gray-900 sm:text-4xl uppercase">
            Contact Us
          </h1>
          <p className="mt-4 text-xl text-gray-600">
            We'd love to hear from you. Get in touch with the InfraShare team.
          </p>
        </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-gray-600">contact@infrashare.com</p>
                  </div>
                </div>
              </div>
              <div className="mt-8">
